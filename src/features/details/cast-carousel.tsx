    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide" style={{ scrollbarWidth: 'none' }}>
        {cast.map((member, index) => (
          ...
          >
            <div className="relative w-14 h-14 rounded-full overflow-hidden bg-zinc-800 ring-2 ring-zinc-700 hover:ring-jagflix-500 transition-all duration-200">
              {member.image ? (
                <Image
            ...
            <div className="text-center">
              ...
              {member.character && (
                <p className="text-[10px] text-zinc-500 truncate max-w-[90px]">
                  {member.character}
                </p>
              )}
            </div>
